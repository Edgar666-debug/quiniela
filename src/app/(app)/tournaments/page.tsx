  ...
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-6 px-6 py-10">
      <div className="space-y-1">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">Selecciona un torneo para navegar por jornadas y ranking.</p>
      </div>
        ...
        {memberships.length === 0 ? (
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Crea o únete desde el dashboard.</CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild>
